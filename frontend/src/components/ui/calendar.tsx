  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: "inline-flex items-center justify-center rounded-xl text-sm font-normal h-9 w-9 p-0 transition-colors hover:bg-accent/30 active:bg-accent/40 aria-selected:opacity-100",
        day_selected:
